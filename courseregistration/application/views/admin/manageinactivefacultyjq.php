...
<div style="width: 240px;" class="alert alert-success"><strong>Error!</strong> <?php echo $this->session->flashdata('success'); echo '</div>'; } ?>
 ...
 <a href="addstudent" class="list-group-item"><span>Add Student</span></a>
  ...
  <a href="managestudentsjq" class="list-group-item"><span>Manage Students</span></a>
    ...
    <a href="manageinactivefacultyjq" class="list-group-item active"><span>manage Faculty Inactive</span></a>
          ...
          <table id="user_data" class="table table-bordered table-striped table-hover">  
                    <thead bgcolor="#a50000">  
                          <tr style="color: white">
                               ...
                               <th width="15%">UpdateFaculty</th>
                               <th width="25%">ActiveFaculty</th>
...
<script type="text/javascript" language="javascript" >  
 $(document).ready(function(){  
      ...
      var dataTable = $('#user_data').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?php echo base_url() . 'Admin/find_faculty_inactive'; ?>",  
                type:"POST"  
           },  
           "columnDefs":[  
                {  
  ...
  //
   //  update
       //making user inactive
           ...
           if(confirm("Are you sure you want to active faculty?"))  
           {  
                $.ajax({  
                     url:"<?php echo base_url() . 'Admin/active_facultyjq'; ?>",  
                     method:"POST",  
       ...
       //making user inactive
           ...
           {  
                $.ajax({  
                     url:"<?php echo base_url() . 'Admin/inactive_facultyjqdelete'; ?>",  
                     method:"POST",  
                     data:{user_id:user_id},  
                     success:function(data)  
                     {  
                          alert('Success fully deleted faculty');  
                          dataTable.ajax.reload();  
                     }  
                });  
           }  
