...
<html>
 ...
 print_r($id);
 $data = $this->Crs_model->get_studentdata($id);
 print_r($data);
 //for the update gender or radiobutton type 
 //write condition like get the value of gender from database
 //make check of the gender value got match
 //in the form user can able to change radio button and update it
        ?>
       <table>
            <tr>
        ...
        <tr><input type="hidden" value="<?php echo $rec['sid']; ?>" name="id" placeholder="id"/></tr>  
...
?> />Female</tr>       
 <tr><br></tr>
    ...
    <tr><br></tr> 
     ...
     <tr><button type="submit" name="submit">Update Student</button></tr>
     <?php echo form_close(); ?>   
</table> 
             <?php } ?>
    </body>
