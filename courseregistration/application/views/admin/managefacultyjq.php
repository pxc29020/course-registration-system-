 ...
 <a href="addstudent" class="list-group-item"><span>Add Student</span></a>
  ...
  <a href="managestudentsjq" class="list-group-item"><span>Manage Students</span></a>
      <a href="manageinactivejq" class="list-group-item"><span>Manage inactive Students</span></a>
         <a href="managefacultyjq" class="list-group-item active"><span>manage Faculty</span></a>
       ...
       <table id="user_data" class="table table-bordered table-striped table-hover">  
                    <thead bgcolor="#a50000">  
                          <tr style="color: white">
                               ...
                               <th width="25%">InactiveFaculty</th>
...
<script type="text/javascript" language="javascript" >  
 $(document).ready(function(){  
      ...
      var dataTable = $('#user_data').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?php echo base_url() . 'Admin/find_faculty'; ?>",  
                type:"POST"  
           },  
           "columnDefs":[  
                {  
   ...
   //  update
         $(document).on('submit', '#user_form', function(event){  
               ...
               var lastname = $('#lastname').val();  
                ...
                {  
                     $.ajax({  
                          url:"<?php echo site_url()?>/Admin/user_action_faculty",  
                          method:'POST',  
       ...
       //making user inactive
           ...
           var user_id = $(this).attr("id");  
           if(confirm("Are you sure you want to make faculty inactive?"))  
           {  
                $.ajax({  
                     url:"<?php echo base_url() . 'Admin/inactive_facultyjq'; ?>",  
                     method:"POST",  
                     data:{user_id:user_id},  
                     success:function(data)  
                     {  
