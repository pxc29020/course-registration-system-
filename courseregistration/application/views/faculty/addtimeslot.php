...
.h2{
 ...
 <a href="addtimeslot" class="list-group-item active"><span>Add My Time Slot</span></a>
...
<div class="alert alert-warning" style="width: 240px;"><strong>Warning!</strong> <?php echo $this->session->flashdata('warning'); echo '</div>'; } ?>       
  ...
  <table>
      <tr>  <br><p class="h3" style="color: white;">Add Time Slot</p>   </tr>
                ...
                <?php echo form_open('Faculty/add_timeslot_faculty');?>
            <tr><br></tr>
         ...
         <tr><br><br></tr>
         <tr>
         <tr><input class="form-control" style="width: 240px;" type="time" name="time" min="9:00" max="18:00" placeholder="Select Timeslot" 
        required="true"/></tr> 
  ...
  <input type="hidden" name="fid" id="fid" value="<?php print_r($this->session->userdata('fid')) ?>" /> 
    ...
    <tr><br><br></tr>
         ...
         <tr><button class="btn btn-primary" type="submit" name="submit">Add Time Slot</button></tr>
     <?php echo form_close(); ?>   
</table></centre></div>
    </body>
</html>
