...
<html>
 ...
 <a href="viewtimeslot" class="list-group-item active"><span>View My Time Slots</span></a>
...
<script type="text/javascript" language="javascript" >  
 $(document).ready(function(){  
      ...
      var dataTable = $('#user_data').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?php echo base_url() . 'Faculty/view_timeslotjq'; ?>",  
                type:"POST"  
           },  
           "columnDefs":[  
                {  
           ...
           if(confirm("Are you sure you want to Inactive Time slot?"))  
           {  
              // alert(user_id);
                $.ajax({  
                     url:"<?php echo base_url() . 'Faculty/inactive_timeslot'; ?>",  
                     method:"POST",  
